...
public class ModuloServiceImplTest {
	...
	public void inserir() throws NamingException, ServiceException {
		...
		m.setNome("Teste");
		m.setProjeto(p);
		ModuloService service = (ModuloService) ejbContainer.getContext()
				.lookup("java:global/AdministracaoService/ModuloServiceImpl");
		service.inserir(m);
	}
	...
	public void lista1() throws NamingException, ServiceException {
		...
		for (Modulo modulo : lista) {
			...
			System.out
					.println("Projeto Nome: " + modulo.getProjeto().getNome());
		}
	}
